...
!    
      do i = 1,M
        AMatOut(1,i) = ArrayIn(1+(M*(i-1)))
        AMatOut(2,i) = ArrayIn(2+(M*(i-1)))
        AMatOut(3,i) = ArrayIn(3+(M*(i-1)))
      endDo
!    
      Return
...
!    
      do i = 1,M
        AMatOut(i,1) = ArrayIn(1+(M*(i-1)))
        AMatOut(i,2) = ArrayIn(2+(M*(i-1)))
        AMatOut(i,3) = ArrayIn(3+(M*(i-1)))
      endDo
      Return

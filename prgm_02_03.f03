...
implicit none
	real :: b,m,l
  integer :: n1,n2
	real ::  PIB_1D_T_Element,PIB_1D_V_Element
...
1000 format(1X,'Hamiltonian matrix element ',I5,',',I5,' is ',F12.5,'.')
      write(*,1000) n1, n2, PIB_1D_T_Element(m,l,n1,n2)+PIB_1D_V_Element(b,m,l,n1,n2)
